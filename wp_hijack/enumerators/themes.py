...
# Common WordPress themes to probe when passive HTML scan finds nothing
...
async def enumerate_themes(
    ...
    # Always probe common theme wordlist in addition to passively discovered ones
    ...
    # Return only themes confirmed to exist (style.css found)
